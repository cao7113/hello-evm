...
import "../../src/basics/7-SimplePaymentChannelV2.sol";

contract SimplePaymentChannelV2Test is Test {
    SimplePaymentChannelV2 public payment;
    ...
    function test_close_asRecipient() public {
        vm.prank(owner);
        payment = new SimplePaymentChannelV2{value: 1 ether}(recipient, 3600);
        vm.stopPrank();
    ...
    function test_claimTimeout_asOwner() public {
        vm.prank(owner);
        SimplePaymentChannelV2 pay = new SimplePaymentChannelV2{value: 1 ether}(owner, 0);
        pay.claimTimeout();
